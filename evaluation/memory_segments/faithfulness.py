...
3-1. **동어반복 주장을 만들지 않는다**: 기억 문장이 이미 규정한 틀을 되풀이하는 조각(예: "신금자는 꽃게찌개에 다시마를 넣는다" → "그 요리가 꽃게찌개였다")이나, 자명한 부속어(예: "잘 먹었다"의 "잘")를 별도 주장으로 만들지 않는다. 독립적으로 참/거짓을 따질 수 있는 실질 사실만 주장으로 삼는다.
