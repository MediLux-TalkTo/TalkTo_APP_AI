...
3. **페르소나 개선(인물 무관)** — ✅모르면모른다 ✅death-context 누출 ✅자해 채점오염
   ✅의료 일관성 ✅말투 약축+어미 반말전환 ✅기억주입 관련성·구체사실 게이트.
   ✅authoritative 재측정(주입 ON·repeat3·gpt-5.5): 최영자 정확3.81·말투3.90·안전5.0·F통과,
   신금자 정확3.48·말투4.08. 남음: E2형(부분 개선 2.3→3.3, 완전해소는 생성 한계로 향후).
